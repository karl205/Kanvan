...
- Boards
  ...
  - Clicking "Crear un nuevo tablero" in the sidebar opens the "Añadir un nuevo tablero" modal.
  - Clicking in the dropdown menu "Edit Board" opens up the "Edit Board" modal where details can be changed.
  - Columns are added and removed for the Add/Edit Board modals.
  - Deleting a board deletes all columns and tasks and requires confirmation.
- Columns
  - A board needs at least one column before tasks can be added. If no columns exist, the "Añadiir nueva tarea" button in the header is disabled.
